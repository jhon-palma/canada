...
class Inscriptions(models.Model):
    ...
    categorie_propriete = models.ForeignKey(ValeursFixes, on_delete=models.CASCADE, related_name='CATEGORIE_PROPRIETE', db_column='CATEGORIE_PROPRIETE')  
    genre_propriete = models.ForeignKey(GenresProprietes, on_delete=models.CASCADE, to_field='genre_propriete' ,db_column='GENRE_PROPRIETE')  
